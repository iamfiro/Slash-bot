...
const forbiddenWords = [
    ...
    "따까리", "장애새끼", "장애년", "찐따년", "싸가지", "창년", "썅년", "고아년", "고아년", "개간년", "종간나", "도구년", "걸래년", "썅년", "씹년",
    "창녀", "머저리", "씹쓰래기", "씹쓰레기", "씹장생", "씹자식", "운1지", "조센징", "매국노", "똥꼬충",
    ...
    "시ㅂㅏ", "ㅅㅂㅏ", "시ㅏㄹ", "씨ㅏㄹ", "ㅅ불", "ㅆ불", "ㅅ쁠", "ㅆ뿔", "ㅆㅣ발", "ㅅㅟ발", "ㅅㅣㅂㅏ", "븅신", "뷴신",
    "ㅣ바알", "ㅅ벌", "^^ㅣ벌",
    "시발", "씨발", "시봘", "씨봘", "씨바", "시바", "샤발", "씌발", "씹발", "시벌", "시팔", "싯팔", "ㅄ", "십련",
    ...
    "개드립", "개돼지", "개씹창", "개간나", "개스끼", "개섹기", "개자식", "개때꺄", "개때끼", "개샛끼", "개가든", "개가뜬", "개가턴", "개가툰", "개가튼",
    "개갇은", "개갈보", "개걸레", "개너마", "개너므", "개넌", "개넘", "개녀나", "개년", "개노마", "개노무새끼", "개논", "개놈", "개뇨나", "개뇬", "개뇸", "개뇽", "개눔",
    "개느마", "개늠", "개때꺄", "개때끼", "개떼끼", "개랙기", "개련", "개색", "개색끼", "개샊", "개샛끼", "개샛키", "개샛킹", "개샛히", "개샜끼",
    ...
    "근혜어", "길라임", "나대블츠", "닭근혜", "댓통령", "레이디가카", "바쁜벌꿀", "수첩공주", "유신공주", "칠푼이", "쿼터갓",
    ...
    async listener(bot, message) {
        ...
        if (isDetected[0]) {
            ...
            const warn = new EmbedBuilder()
                .setColor('Red')
                .setTitle('🚨 비속어 감지')
                .setFields({ name: '감지된 메시지', value: `\`\`\`${message.content}\`\`\``, inline: true }, { name: '감지된 단어', value: `\`\`\`${isDetected[1]}\`\`\`` }, { name: '유저', value: `<@${message.author.id}>`, inline: true })
